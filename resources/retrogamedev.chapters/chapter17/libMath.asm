...
defm    LIBMATH_ADD8BIT_AAA     ; /1 = 1st Number (Address)
...
defm    LIBMATH_ADD8BIT_AVA     ; /1 = 1st Number (Address)
                                ; /2 = 2nd Number (Value)
                                ; /3 = Sum (Address)
        clc     ; Clear carry before add
        lda /1  ; Get first number
...
defm    LIBMATH_ADD16BIT_AAVAAA ; /1 = 1st Number High Byte (Address)
...
defm    LIBMATH_ADD16BIT_AAVVAA ; /1 = 1st Number High Byte (Address)
                                ; /2 = 1st Number Low Byte (Address)
                                ; /3 = 2nd Number High Byte (Value)
...
defm    LIBMATH_SUB8BIT_AAA     ; /1 = 1st Number (Address)
                                ; /2 = 2nd Number (Address)
                                ; /3 = Sum (Address)
...
defm    LIBMATH_SUB8BIT_AVA     ; /1 = 1st Number (Address)
                                ; /2 = 2nd Number (Value)
                                ; /3 = Sum (Address)
        sec     ; sec is the same as clear borrow
        lda /1  ; Get first number
...
defm    LIBMATH_SUB16BIT_AAVAAA ; /1 = 1st Number High Byte (Address)
                                ; /2 = 1st Number Low Byte (Address)
                                ; /3 = 2nd Number High Byte (Value)
                                ; /4 = 2nd Number Low Byte (Address)
                                ; /5 = Sum High Byte (Address)
...
defm    LIBMATH_SUB16BIT_AAVVAA ; /1 = 1st Number High Byte (Address)
                                ; /2 = 1st Number Low Byte (Address)
                                ; /3 = 2nd Number High Byte (Value)
                                ; /4 = 2nd Number Low Byte (Value)
                                ; /5 = Sum High Byte (Address)
